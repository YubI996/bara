    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                description:
                    'Autentikasi dua faktor sudah aktif. Pindai kode QR atau masukkan kunci penyiapan di aplikasi autentikator Anda.',
                buttonText: 'Tutup',
            };
        }
        ...
        return {
            ...
            description:
                'Untuk menyelesaikan aktivasi 2FA, pindai kode QR atau masukkan kunci penyiapan di aplikasi autentikator Anda',
            buttonText: 'Lanjut',
        };
